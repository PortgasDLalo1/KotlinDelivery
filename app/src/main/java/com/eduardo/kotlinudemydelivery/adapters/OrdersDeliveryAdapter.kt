...
import com.eduardo.kotlinudemydelivery.activities.delivery.orders.detail.DeliveryOrdersDetailActivity
import com.eduardo.kotlinudemydelivery.activities.restaurant.home.RestaurantHomeActivity
import com.eduardo.kotlinudemydelivery.activities.restaurant.orders.detail.RestaurantOrdersDetailActivity
...
class OrdersDeliveryAdapter(val context: Activity, val orders: ArrayList<Order>): RecyclerView.Adapter<OrdersDeliveryAdapter.OrdersViewHolder>() {
    ...
    class OrdersViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        init {
            textViewOrderId = view.findViewById(R.id.textview_orderR)
            textViewDate = view.findViewById(R.id.textview_dateR)
            textViewAddress = view.findViewById(R.id.textview_addressR)
            textViewClient = view.findViewById(R.id.textview_clientR)
        }
